...
function seedIfEmpty() {
  ...
  if (!localStorage.getItem(ADMIN_ACTIVITIES_KEY)) {
    const activities: AdminActivity[] = [
      { id: "act_001", name: "Beach Sunset Cruise", city: "Goa", country: "India", category: "water", durationHours: 2, costInr: 1500, description: "Evening cruise with live music and dinner", image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800", imageAlt: "Goa sunset cruise" },
      ...
      { id: "act_003", name: "Amber Fort Guided Tour", city: "Jaipur", country: "India", category: "heritage", durationHours: 4, costInr: 800, description: "Guided tour of Amber Fort with elephant ride", image: "https://images.unsplash.com/photo-1599661046827-dacde4a9b8e8?w=800", imageAlt: "Amber Fort Jaipur" },
      { id: "act_004", name: "Houseboat Overnight Stay", city: "Kerala Backwaters", country: "India", category: "wellness", durationHours: 24, costInr: 8000, description: "Traditional houseboat with meals and Ayurvedic massage", image: "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800", imageAlt: "Kerala houseboat" },
      ...
      { id: "act_006", name: "Scuba Diving at Havelock", city: "Andaman Islands", country: "India", category: "water", durationHours: 4, costInr: 4500, description: "Certified scuba diving with coral reef exploration", image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800", imageAlt: "Andaman scuba diving" },
